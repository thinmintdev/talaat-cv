  ...
  return (
    <>
            ...
            <div className={HOMEPAGE_DATA.layout.sections.titleColumn}>
              <h2 className={HOMEPAGE_DATA.layout.typography.sectionTitle}>
                <TypingTitle
                  ...
                  speed={
                    HOMEPAGE_DATA.layout.components.typingTitle.about.speed
                  }
                  delay={
                    HOMEPAGE_DATA.layout.components.typingTitle.about.delay
                  }
                />
              </h2>
            </div>
      ...
      {HOMEPAGE_DATA.projects.list.length > 0 && (
        <section
          id="projects"
          className={HOMEPAGE_DATA.layout.sections.padding}
        >
          <div>
            <div className={HOMEPAGE_DATA.layout.sections.containerGrid}>
              <div className={HOMEPAGE_DATA.layout.sections.titleColumn}>
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold text-gray-900 mb-4">
              <TypingTitle
                ...
                speed={
                  HOMEPAGE_DATA.layout.components.typingTitle.contact.speed
                }
                delay={
                  HOMEPAGE_DATA.layout.components.typingTitle.contact.delay
                }
              />
            </h2>
